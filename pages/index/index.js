...
var refreshPageData2 = function(y,m){
      ...
      for( var i = 0; i<42; i++){
          ...
          switch(m)
    				{
              case 8: weekNum[i] = Math.floor((i-30)/7);break;
    					case 9: weekNum[i] = Math.floor((i-7)/7);break;
    					case 10: weekNum[i] = Math.floor((i-7+29)/7);break;
              case 11: weekNum[i] = Math.floor((i-7+29+35)/7); break;
    					case 12: weekNum[i] = Math.floor((i+8+31+30+31)/7);break;
    					case 1: weekNum[i] = Math.floor((i+8+31+30+31+30)/7);break;
    				}
          }
